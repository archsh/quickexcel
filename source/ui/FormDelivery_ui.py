...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "发货记录/退货记录", None))
        self.label_9.setText(_translate("Form", "发货单号：", None))
        self.label_5.setText(_translate("Form", "客 户：", None))
        self.label_4.setText(_translate("Form", "物 料：", None))
        self.label_7.setText(_translate("Form", "单 价：", None))
        self.label_8.setText(_translate("Form", "金 额：", None))
        self.label_6.setText(_translate("Form", "日 期：", None))
        self.label_11.setText(_translate("Form", "收货人：", None))
        self.label_12.setText(_translate("Form", "业务员：", None))
