...
#
# Created: Wed Jul 24 12:12:18 2013
...
class Ui_TableRecords(object):
    def setupUi(self, TableRecords):
        ...
        self.pushButton_Reload = QtGui.QPushButton(TableRecords)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/glyphicons_081_refresh.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/glyphicons_191_circle_minus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/glyphicons_193_circle_ok.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_Modify.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/glyphicons_190_circle_plus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_New.setIcon(icon6)
    ...
    def retranslateUi(self, TableRecords):
        ...
        self.pushButton_Filter.setShortcut(_translate("TableRecords", "Ctrl+F", None))
        ...
        self.pushButton_Delete.setShortcut(_translate("TableRecords", "Ctrl+D", None))
        self.pushButton_Modify.setText(_translate("TableRecords", "修改 (&E)", None))
        self.pushButton_Modify.setShortcut(_translate("TableRecords", "Ctrl+E", None))
        self.pushButton_New.setText(_translate("TableRecords", "新增 (&N)", None))
        self.pushButton_New.setShortcut(_translate("TableRecords", "Ctrl+N", None))
